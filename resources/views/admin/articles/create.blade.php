                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info content_explanation" role="alert">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{ route('hcs-admin.articles.store') }}" method="post" id="main_form" enctype='multipart/form-data'>
                                            @csrf
                                            @include('admin.articles.form', ['register_mode' => $register_mode])
                                            <div class="row">
                                                <div class="col-md-12">
