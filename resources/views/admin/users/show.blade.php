...
<div class="modal" id="detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="item1" role="tabpanel" aria-labelledby="item1-tab">
                        <div class="row">
                            <div class="col-6">
                                <dl class="row">
                                    <dt class="col-4 text-right">都道府県</dt>
                                    <dd class="col-8"><span id="detail_prefecture" class="detail-view"></span></dd>
                                </dl>
                                <dl class="row">
                                    <dt class="col-4 text-right">生年月日</dt>
                                    <dd class="col-8"><span id="detail_birthday" class="detail-view"></span></dd>
                                </dl>
                                <dl class="row">
                                    <dt class="col-4 text-right">公開ステータス</dt>
